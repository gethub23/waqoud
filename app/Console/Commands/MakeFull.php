...
#clases_Definition_here' , 
        ...
        #new_routes_here
            ...
            // call back  
            $this->info('New Repo , Interface , Controller , Model , DataBase Migrate , optional [seeder , form request , observer] , Blade Folder And Blade File , basic [index - store - update - delete] routes in web.php file for dashboard  created ! ');
            // #call back
