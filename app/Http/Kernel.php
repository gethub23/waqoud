...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'Subscribe'        => \App\Http\Middleware\SubscribeMiddelware::class,
        'charge'           => \App\Http\Middleware\ChargeMiddelware::class,
        'SubscibeCredit'   => \App\Http\Middleware\SubscibeCreditMiddelware::class,
        'worker'           => \App\Http\Middleware\WorkerMiddleware::class,
        'jwtOptional' 	   => \App\Http\Middleware\JwtOptionalMiddleware::class,
