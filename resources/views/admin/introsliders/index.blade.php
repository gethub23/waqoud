...
<x-admin.breadcrumb singleName='{{awtTrans("بنر")}}' deletebutton="true" addbutton="true" >
...
@section('content')
                        ...
                        <tr class="delete_row_{{$row->id}}">
                            ...
                            <td>
                                <x-admin.edit-button>
                                    <x-slot name="data">
                                            data-id              = '{{$row->id}}'
                                            data-route           = '{{route('admin.introsliders.update' , [$row->id])}}'
                                ...
                                <x-admin.delete route="{{route('admin.introsliders.delete' , [$row->id])}}" />
                            </td>
                        </tr>
                    @endforeach
                </x-slot>
 ...
 <!-- add model -->
    <x-admin.AddModel route='{{route("admin.introsliders.store")}}' singleName='{{awtTrans("بنر")}}' >
        <x-slot name="inputs">
           <div class="col-12">
 ...
 <!-- edit model -->
    <x-admin.edit-model singleName='{{awtTrans("بنر")}}' >
        <x-slot name="inputs">
          <div class="col-sm-12">  
                <div class="imgMontg">
                    <div class="dropBox">
 ...
 <!-- show model -->
    <x-admin.show-model  singleName='{{awtTrans("بنر")}}' >
        <x-slot name="inputs">
          <div class="col-sm-12">  
                <div class="imgMontg">
                    <div class="dropBox">
...
{{-- delete all model  --}}
    <x-admin.delete-all route="{{route('admin.introsliders.deleteAll')}}" />
{{-- #delete all model  --}}
