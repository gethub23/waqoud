...
@section('content')
                        ...
                        <tr class="delete_row_{{$row->id}}">
                            ...
                            <td>
                                <x-admin.edit-button>
                                    <x-slot name="data">
                                            data-id              = '{{$row->id}}'
                                            data-route           = '{{route('admin.intros.update' , [$row->id])}}'
                                ...
                                <x-admin.delete route="{{route('admin.intros.delete' , [$row->id])}}" />
                            </td>
                        </tr>
                    @endforeach
                </x-slot>
 ...
 <!-- add model -->
    <x-admin.AddModel route='{{route("admin.intros.store")}}' singleName='{{awtTrans("بنر")}}' >
        <x-slot name="inputs">
           <div class="col-12">
