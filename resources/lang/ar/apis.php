...
return [
    ...
    */
    ...
    'not_subscribed'           => 'غير مسموح لك يجب الاشتراك اولا' ,
    'have_no_credit'           => 'لايوجد لديك رصيد كافي في حسابك' ,
    'complaint_send'           => 'تم ارسال شكوتك للأدراه' ,
    'message_sent'             => 'تم ارسال رسالتك للأدراه' ,

    'order_request_success'    => 'تم ارسال طلب ملئ الوقود بنجاح بانتظار تأكيد العميل' ,
    'user_have_no_credit'      => 'العميل لايملك المال الكافي لتنفيذ الطلب ' ,
